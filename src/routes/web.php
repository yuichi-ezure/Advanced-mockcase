...
Route::get('/menu2', [Menu2Controller::class, 'getMenu2']);
Route::get('/menu1', [Menu1Controller::class, 'getMenu1']);
Route::get('/mypage', [MypageController::class, 'getMypage']);
Route::get('/thanks', [ThanksController::class, 'getThanks']);
Route::get('/done', [ThanksController::class, 'getDone']);
